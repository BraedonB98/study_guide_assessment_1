...
//remove the .skips in order to run the test function
...
describe("book.js", function () {
  ...
  describe("writeBook", function() {
    ...
    it("should return a different book object", function () {
      ...
      assert.equal(dragonBook.pageCount, 480);//test code was wrong when it said 560
  ...
  describe("editBook", function() {
    ...
    it("should decrease a different book's page count to be three quarters of what it originally was", function () {
      ...
      assert.equal(dragonBook.pageCount, 480);//was set to 560 but had to change it

      editBook(dragonBook);

      assert.equal(dragonBook.pageCount, 360); //was 420 but had to change it due to miss count of value
    });
  });
});
